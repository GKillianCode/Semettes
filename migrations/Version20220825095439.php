 ...
 */
final class Version20220825095439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, week_slot_id_id INT NOT NULL, meeting_room_id_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, booking_id VARCHAR(255) NOT NULL, date_time DATETIME NOT NULL, UNIQUE INDEX UNIQ_E00CEDDE11D166D0 (week_slot_id_id), UNIQUE INDEX UNIQ_E00CEDDE8C68C142 (meeting_room_id_id), UNIQUE INDEX UNIQ_E00CEDDE9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE meeting_room (id INT AUTO_INCREMENT NOT NULL, room_name VARCHAR(255) NOT NULL, room_description VARCHAR(255) DEFAULT NULL, room_image_name VARCHAR(255) NOT NULL, max_person SMALLINT NOT NULL, rate VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
